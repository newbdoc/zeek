...
namespace analyzer::dns {
	...
	using TCP_DNS_state [[deprecated("Remove in v4.1. Use zeek::analyzer::dns::TCP_DNS_state.")]] = zeek::analyzer::dns::TCP_DNS_state;
	constexpr auto DNS_LEN_HI [[deprecated("Remove in v4.1. Use zeek::analyzer::dns::DNS_LEN_HI.")]] = zeek::analyzer::dns::DNS_LEN_HI;
	constexpr auto DNS_LEN_LO [[deprecated("Remove in v4.1. Use zeek::analyzer::dns::DNS_LEN_LO.")]] = zeek::analyzer::dns::DNS_LEN_LO;
	constexpr auto DNS_MESSAGE_BUFFER [[deprecated("Remove in v4.1. Use zeek::analyzer::dns::DNS_MESSAGE_BUFFER.")]] = zeek::analyzer::dns::DNS_MESSAGE_BUFFER;

	using DNS_Interpreter [[deprecated("Remove in v4.1. Use zeek::analyzer::dns::DNS_Interpreter.")]] = zeek::analyzer::dns::DNS_Interpreter;
